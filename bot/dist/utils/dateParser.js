...
function parseRecurrence(input) {
    ...
    if (!minutes)
        return null;
    if (minutes === 1440)
        return { intervalMinutes: minutes, recurrenceText: "Har kuni" };
    if (minutes === 10080)
        return { intervalMinutes: minutes, recurrenceText: "Har hafta" };
    if (minutes === 43200)
        return { intervalMinutes: minutes, recurrenceText: "Har oy" };
    if (minutes % 1440 === 0) {
